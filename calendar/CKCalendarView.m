...
- (NSDate *)_firstDayOfMonthContainingDate:(NSDate *)date {
    ...
    NSDateComponents *comps = [self.calendar components:NSCalendarUnitDay | NSCalendarUnitMonth | NSCalendarUnitYear fromDate:date];
...
//        NSDateComponents *day2 = [self.calendar components:NSYearCalendarUnit|NSMonthCalendarUnit fromDate:otherDate];
    ...
    NSDateComponents *day = [self.calendar components:NSCalendarUnitMonth | NSCalendarUnitYear fromDate:date];
    NSDateComponents *day2 = [self.calendar components:NSCalendarUnitMonth | NSCalendarUnitYear fromDate:otherDate];
...
//    NSDateComponents *day2 = [self.calendar components:NSEraCalendarUnit|NSYearCalendarUnit|NSMonthCalendarUnit|NSDayCalendarUnit fromDate:date2];
 ...
 NSDateComponents *day = [self.calendar components:NSCalendarUnitWeekday fromDate:date1];
    
    NSDateComponents *day2 = [self.calendar components:NSCalendarUnitDay|NSCalendarUnitMonth|NSCalendarUnitYear|NSCalendarUnitEra fromDate:date2];
